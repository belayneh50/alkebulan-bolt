...
const EthiopianCalendar: React.FC = () => {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-t border-cyan-400/20 bg-black px-4 py-8"
      ...
      >
        <div className="relative flex h-full flex-col justify-start overflow-hidden rounded-2xl border border-cyan-300/60 bg-slate-950/95 p-6 shadow-[0_0_20px_rgba(0,238,255,0.08)]">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="pointer-events-none absolute left-1/2 top-1/2 w-48 -translate-x-1/2 -translate-y-1/2 opacity-[0.04] mix-blend-screen"
          />
          ...
          <header className="relative mb-6 text-center">
            ...
            <h2 id="ethiopian-calendar-title" className="text-xl font-bold text-white sm:text-2xl">
            ...
            {Array.from({ length: monthLength }, (_, index) => index + 1).map((day) => {
              ...
              return (
                <div
                  ...
                  className={`flex aspect-square min-h-6 items-center justify-center rounded-lg border text-[0.65rem] font-semibold transition sm:text-xs ${
                    isToday
