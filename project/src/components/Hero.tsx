          ...
          >
            ...
            <motion.button
              ...
              onClick={() => {
                ...
                className="px-8 py-4 rounded-lg border-2 border-[var(--neon-green)] text-[var(--neon-green)] font-bold hover:bg-[var(--neon-green)] hover:text-black transition-all"
                style={{ boxShadow: '0 0 20px var(--neon-green)' }}
            >
              VIEW PROJECTS
            </motion.button>
          </motion.div>
